...
const VehiclesFooter = () => {
  ...
  return (
    <footer className="bg-gray-50 text-gray-500">
      {/* Blue Gradient Line */}
      <div className="h-px bg-gradient-to-r from-transparent via-[#0a7bb3]/30 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              {[Facebook, Instagram, Twitter, Youtube].map((Icon, i) => (
                <a key={i} href="#" className="w-9 h-9 border border-gray-200 flex items-center justify-center hover:border-[#0a7bb3]/50 hover:text-[#0a7bb3] transition-all rounded-lg">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-gray-900 text-xs font-bold tracking-[0.15em] uppercase mb-4">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-gray-900 text-xs font-bold tracking-[0.15em] uppercase mb-4">Services</h3>
            <ul className="space-y-2.5 text-sm">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-gray-900 text-xs font-bold tracking-[0.15em] uppercase mb-4">Contact Us</h3>
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                <MapPin className="h-4 w-4 mt-0.5 shrink-0 text-[#0a7bb3]" />
                <span>{settings.address}</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4 shrink-0 text-[#0a7bb3]" />
                <span>{settings.phoneNumber}</span>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 shrink-0 text-[#0a7bb3]" />
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-400">
          ...
          <div className="flex gap-4">
            <a href="#" className="hover:text-[#0a7bb3] transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-[#0a7bb3] transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
